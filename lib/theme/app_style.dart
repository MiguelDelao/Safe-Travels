...
class AppStyle {
  ...
  static TextStyle txtPoppinsExtraLight9 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular34 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      34,
    ),
  ...
  static TextStyle txtPoppinsRegular1825 = TextStyle(
  ...
  static TextStyle txtPoppinsLight1225 = TextStyle(
    color: ColorConstant.green600Ce01,
    fontSize: getFontSize(
      12.25,
    ),
    fontFamily: 'Poppins',
